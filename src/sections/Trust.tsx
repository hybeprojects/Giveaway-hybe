...
export default function Trust() {
  return (
    <section className="section trust-section" aria-label="Trust">
      <div className="container">
        <h2 className="section-title">Trust & Transparency</h2>
        <div className="trust-grid">
          <div className="card card-pad trust-card">
            ...
            <div className="trust-verified mt-10">
            ...
            <div className="trust-badges mt-10">
              <span className="trust-chip"><FiLock aria-hidden /> SSL Secure</span>
              <span className="trust-chip"><FiShield aria-hidden /> Fair Draw</span>
              <span className="trust-chip"><FiEye aria-hidden /> Privacy First</span>
            </div>
          </div>
